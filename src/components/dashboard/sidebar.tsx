...
const Sidebar = () => {
  ...
  return (
    <aside
      className={`sidebar bg-neutral-200 dark:bg-neutral-900 ${
        collapsed ? "w-9" : "w-48"
        ...
        <div className="sidebar-content w-full flex flex-col items-start justify-start px-1 py-4 gap-2">
          <div
            className={`w-full flex flex-col gap-1 ${
              isPagesSection ? activeStyles : ""
            } p-1 rounded-md`}
          >
            <Link
              href="/dashboard/pages"
              className={`sidebar-link w-fit sm:w-full font-normal text-sm transition duration-300 rounded-md hover:bg-primary/60 dark:hover:bg-d-primary-light/40 px-1 py-0.5 flex items-center ${
          ...
          {pageSlug && (
            <Link
              ...
              className={`sidebar-link w-fit sm:w-full font-normal text-sm transition duration-300 p-1 rounded-md ${
                pathname === `/dashboard/pages/${pageSlug}/analytics`
                  ? activeStyles
                  : "text-neutral-700 dark:text-neutral-200"
