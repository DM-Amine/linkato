  ...
  return (
    <DrawerPortal data-slot="drawer-portal">
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          "group/drawer-content fixed z-50 max-w-full border border-neutral-500 sm:w-[600px] rounded-tr-3xl rounded-tl-3xl mx-auto flex h-auto flex-col bg-neutral-100 dark:bg-neutral-700",
