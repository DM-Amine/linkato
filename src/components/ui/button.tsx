...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "cursor-pointer text-neutral-700   bg-primary dark:bg-d-primary shadow-xs hover:bg-primary/60 hover:dark:bg-primary/90 h-fit gap-1 border border-neutral-50 dark:border-neutral-700 shadow-sm  px-2 py-0",
        destructive:
        ...
        outline:
          " cursor-pointer border-neutral-400 dark:border-neutral-300 text-neutral-600 dark:text-neutral-300 hover:bg-neutral-200 hover:dark:bg-neutral-700 hover:dark:border-neutral-600",
        secondary:
      ...
      size: {
        default: "h-6 px-1 py-1 has-[>svg]:px-1 ",
